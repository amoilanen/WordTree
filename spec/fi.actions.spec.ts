...
describe('Finnish action forms', function() {
  shouldHaveActionForms(fi, Word.sing, {
    now: {
      I: 'laulan',
      you: 'laulat',
      you_formal: 'laulat',
  ...
  shouldHaveActionForms(fi, wordDo, {
    now: {
      I: 'teen',
      you: 'teet',
      you_formal: 'teet',
  ...
  shouldHaveActionForms(fi, Word.go, {
    now: {
      I: 'menen',
      you: 'menet',
      you_formal: 'menet',
  ...
  shouldHaveActionForms(fi, Word.sew, {
    now: {
      I: 'omelen',
      you: 'omelet',
      you_formal: 'omelet',
  ...
  shouldHaveActionForms(fi, Word.build, {
    now: {
      I: 'rakennan',
      you: 'rakennat',
      you_formal: 'rakennat',
  ...
  shouldHaveActionForms(fi, Word.give, {
    now: {
      I: 'annan',
      you: 'annat',
      you_formal: 'annat',
  ...
  shouldHaveActionForms(fi, Word.look, {
    now: {
      I: 'katson',
      you: 'katsot',
      you_formal: 'katsot',
  ...
  shouldHaveActionForms(fi, Word.see, {
    now: {
      I: 'näen',
      you: 'näet',
      you_formal: 'näet',
  ...
  shouldHaveActionForms(fi, Word.want, {
    now: {
      I: 'haluan',
      you: 'haluat',
      you_formal: 'haluat',
  ...
  shouldHaveActionForms(fi, Word.can, {
    now: {
      I: 'voin',
      you: 'voit',
      you_formal: 'voit',
