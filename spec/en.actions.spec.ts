...
describe('English action forms', function() {
  shouldHaveActionForms(en, Word.sing, {
    now: {
      I: 'sing',
      you: 'sing',
      you_formal: 'sing',
  ...
  shouldHaveActionForms(en, wordDo, {
    now: {
      I: 'do',
      you: 'do',
      you_formal: 'do',
  ...
  shouldHaveActionForms(en, Word.go, {
    now: {
      I: 'go',
      you: 'go',
      you_formal: 'go',
  ...
  shouldHaveActionForms(en, Word.sew, {
    now: {
      I: 'sew',
      you: 'sew',
      you_formal: 'sew',
  ...
  shouldHaveActionForms(en, Word.build, {
    now: {
      I: 'build',
      you: 'build',
      you_formal: 'build',
  ...
  shouldHaveActionForms(en, Word.give, {
    now: {
      I: 'give',
      you: 'give',
      you_formal: 'give',
  ...
  shouldHaveActionForms(en, Word.look, {
    now: {
      I: 'look',
      you: 'look',
      you_formal: 'look',
  ...
  shouldHaveActionForms(en, Word.see, {
    now: {
      I: 'see',
      you: 'see',
      you_formal: 'see',
  ...
  shouldHaveActionForms(en, Word.want, {
    now: {
      I: 'want',
      you: 'want',
      you_formal: 'want',
  ...
  shouldHaveActionForms(en, Word.can, {
    now: {
      I: 'can',
      you: 'can',
      you_formal: 'can',
