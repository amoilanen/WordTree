...
describe('Dutch action forms', function() {
  ...
  shouldHaveActionForms(nl, wordDo, {
    now: {
      I: 'doe',
      you: 'doet',
      you_formal: 'doet',
  ...
  shouldHaveActionForms(nl, Word.go, {
    now: {
      I: 'ga',
      you: 'gaat',
      you_formal: 'gaat',
  ...
  shouldHaveActionForms(nl, Word.sew, {
    now: {
      I: 'naai',
      you: 'naait',
      you_formal: 'naait',
  ...
  shouldHaveActionForms(nl, Word.build, {
    now: {
      I: 'bouw',
      you: 'bouwt',
      you_formal: 'bouwt',
  ...
  shouldHaveActionForms(nl, Word.give, {
    now: {
      I: 'geef',
      you: 'geeft',
      you_formal: 'geeft',
  ...
  shouldHaveActionForms(nl, Word.look, {
    now: {
      I: 'kijk',
      you: 'kijkt',
      you_formal: 'kijkt',
  ...
  shouldHaveActionForms(nl, Word.see, {
    now: {
      I: 'zie',
      you: 'ziet',
      you_formal: 'ziet',
  ...
  shouldHaveActionForms(nl, Word.want, {
    now: {
      I: 'wil',
      you: 'wilt',
      you_formal: 'wilt',
  ...
  shouldHaveActionForms(nl, Word.can, {
    now: {
      I: 'kan',
      you: 'kunt',
      you_formal: 'kunt',
